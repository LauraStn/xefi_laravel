...
@section('content')
    ...
    <div class="d-grid d-md-flex justify-content-md-end gap-3 mb-2">
        <a href="{{ route('home') }}" class="btn btn-dark">Affichage utilisateurs</a>
        <a href="{{ route('dish.create') }}" class="btn btn-info">Créer un plat</a>
    </div>
